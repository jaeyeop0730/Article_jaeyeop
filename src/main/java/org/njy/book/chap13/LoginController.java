...
import org.njy.book.chap11.MemberDao;
...
public class LoginController {
	 ...
	 */
	@PostMapping("/login")
	public String submit(@RequestParam("email") String email, @RequestParam("password") String password, HttpSession session) {
		try {
